...
<div class="content" id="content">
    <div class="navbar">
        ...
        <div class="nav-links">
            <a href="recetarioo.php">Recetas</a>
            <a href="#">Contacto</a>
...
<div class="contenedor">
    <div class="info">
        <h1>Bienvenidos a PasteLal</h1>
        <p>En PasteLal, nos apasiona crear experiencias dulces y memorables para nuestros clientes. Ubicados en el corazón de la ciudad, nos especializamos en ofrecer una amplia variedad de pasteles, tartas y dulces que no solo deleitan el paladar, sino que también encantan la vista.</p>
